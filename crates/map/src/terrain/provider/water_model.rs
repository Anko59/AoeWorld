...
type ModeledWater = (HydrologyKind, Option<i32>, WaterModelProvenance);
type TypedWaterEvidence = (
...
) -> Result<TypedWaterEvidence, EnvironmentPageError> {
